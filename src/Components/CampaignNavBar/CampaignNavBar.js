        ...
        <div ref={wrapperRef}>
            <div className='nav-content'>
                ...
                <div className='nav-link'>
                    <Button 
                    onClick={showSidebar}
                    endIcon={<MenuIcon style={{fontSize: 'min(10vw, 48px)', fontWeight :"bold", color:"white"}}/>}
                    />
                </div>
            </div>
            ...
            <div className='nav-div-sidebar example'>
                <div className="nav-div-close-wrapper">
                    <Link className='nav-link' to='#'>
                        <AiIcons.AiOutlineClose className='red-icon' style={{color:"white", fontSize:"38px"}} onClick={showSidebar}/>
                    </Link>
                </div>
