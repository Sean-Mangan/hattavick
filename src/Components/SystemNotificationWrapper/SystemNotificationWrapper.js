...
const SystemNotificationWrapper = () => {
    ...
    const { data: partyData, isFetching: partyFetching, isError: partyError } = useGetPartyDataQuery(campaignId);
          ...
          setNotifications([
            {
              ...
              message: "Look like you haven't added any friends to the campaign yet. You can add party members from the campaign settings! Added players can view, interact with and create notes for the campaign!",
              severity: "info",
            },
          ]);
      ...
      <>
        {notifications.map((notification, idx) => (
          showNotifications[idx] && (
            ...
            >
              <AlertTitle>{notification.title || "System Notification"}</AlertTitle>
